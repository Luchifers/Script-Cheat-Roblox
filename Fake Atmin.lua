...
local function executeCommand(player, cmd, args)
	...
	elseif cmd == "ban" then
		...
		if target then
			...
			print(player.Name.." he banned "..target.Name)
		else
			player:SendMessage("Player not found!")
		end
	elseif cmd == "teleport" then
		...
		if target then
			...
			print(player.Name.." he teleported "..target.Name)
		end
